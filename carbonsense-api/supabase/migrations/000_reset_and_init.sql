DROP FUNCTION IF EXISTS public.join_team_atomic(uuid, text) CASCADE;
DROP FUNCTION IF EXISTS public.create_team_with_admin(uuid, text, text, text, text) CASCADE;
DROP FUNCTION IF EXISTS public.set_updated_at() CASCADE;

DROP TABLE IF EXISTS public.copilot_conversations CASCADE;
DROP TABLE IF EXISTS public.carbon_summaries CASCADE;
